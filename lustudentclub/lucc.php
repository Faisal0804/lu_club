        ...
        <div class="container">
            <div class="about">
                <div class="about-content">
                    ...
                    <p>An LUCC Student Branch provides opportunities to meet and learn from fellow LUCC Student and Graduate Student Members and engage with professional LUCC members locally.An active LUCC Student Branch can be one of the most positive elements of your academic career, offering programs, activities, and professional networking opportunities that build critical skills outside of the class.</p>
                    <a href="" class="btn">Get More Info</a>
                </div>
                <div class="about-img">
                    <img src="assets/img/lucc/about/about1.jpg" alt="">
                    <img src="assets/img/lucc/about/about2.jpg" alt="">
                    <img src="assets/img/lucc/about/about3.jpg" alt="">
                    <img src="assets/img/lucc/about/about4.jpg" alt="">
                </div>
            </div>
        </div>
    </section>
