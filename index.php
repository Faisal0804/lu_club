                ...
                <div class="container">
                    ...
                    <?php 
                        ...
                        <div class="single-club">
                            <a href="lucc.html"><img src="admin/<?php echo $result_club['image'];?>" alt=""></a>
                            <a href="lucc.html"><h4><?php echo $result_club['club_name'] ;?><span><?php echo $result_club['club_title']; ?></span></h4></a>
