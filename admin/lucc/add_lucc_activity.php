						 ...
						 $db=new database();
						  ...
						  if(isset($_POST['submit'])){
							  ...
							  if(empty($clubid) || empty($event_description)){
								...
								$insert_query="insert into club_activities(club_id,activity_image,activity_title,activity_description) 
                                values('$clubid','$activity_title','$main_image','$activity_description')";
