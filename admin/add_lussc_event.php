						  ...
						  if(isset($_POST['submit'])){
							 ...
							 $clubid=$_POST['club_id'];
							  ...
							  if(empty($clubid) || empty($event_description)){
								...
								$insert_query="insert into club_event(club_id,event_title,event_image,event_start_date,event_end_date,event_start_time,event_end_time,event_description) 
                                values('$clubid','$event_title','$main_image','$event_start_date','$event_end_date','$event_start_time','$event_end_time','$event_description')";
							   ...
							   <div class="form-group">
									...
									<div class="col-sm-8">
										<select name="club_id" id="">
                                           ...
                                           <?php
                                            $selectclub="select * from clublist where club_name='lussc'";
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="date" class="form-control1" name="event_start_date"  placeholder="Create club" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="date" class="form-control1" name="event_end_date"  placeholder="Create club" >
									</div>
								</div>
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="time" class="form-control1" name="event_start_time"  placeholder="Create club" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="time" class="form-control1" name="event_end_time"  placeholder="Create club" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea name="event_description" class="form-control1" id="" cols="30" rows="10">
