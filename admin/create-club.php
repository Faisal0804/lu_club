  	         ...
  	         <div class="tab-content">
						...
						//club insert
						 ...
						 if(isset($_POST['submit'])){
							  ...
							  $file=$_FILES['club_logo']['name'];
							  $temp_file=$_FILES['club_logo']['tmp_name'];
							  ...
							  if(empty($clubname) || empty( $clubtitle)){
								...
								$insert_query="insert into clublist(club_name,club_title,club_logo) values('$clubname','$clubtitle','$main_image')";
						...
						?>
							...
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
							   ...
							   <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="club_name" placeholder="Club Name" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="club_title" placeholder="Club Title" required>
									</div>
								</div>

								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Club Logo</label>
									<div class="col-sm-8">
										<input type="file" class="form-control1" name="club_logo"  placeholder="Club Logo" >
									</div>
								</div>
