						...
						//club insert
						 $db=new database();
						  ...
						  if(isset($_POST['submit'])){
							  ...
							  if(empty($clubid) || empty( $desccription)){
								echo "field must not be empty";
							  }else{
								$insert_query="insert into club_pst(club_id,desccription,image) values('$clubid','$desccription','$main_image')";
							...
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
							   ...
							   <div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea name="desccription" id="" cols="30" rows="10">
