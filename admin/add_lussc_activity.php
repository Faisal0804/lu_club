						...
						//club insert
						 $db=new database();
						  ...
						  if(isset($_POST['submit'])){
							  ...
							  if(empty($clubid) || empty($activity_description)){
								echo "field must not be empty";
							  }else{
								$insert_query="insert into club_activities(club_id,activity_title,activity_description,activity_image) 
                                values('$clubid','$activity_title','$activity_description','$main_image')";
							...
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
							   ...
							   <div class="form-group">
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="activity_title"  placeholder="Create club" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea name="activity_description" id="" cols="30" rows="10">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="file" class="form-control1" name="activity_image" placeholder="Create club" >
									</div>
								</div>
