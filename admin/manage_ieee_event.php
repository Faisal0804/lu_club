					  ...
					  <h2>Manage IEEE Event</h2>
						...
						?>
						  ...
						  <tr>
                            ...
                            <td>
                                <td><?php echo $result_club_event['event_start_date'] ;?></td>
                                <td><?php echo $result_club_event['event_end_date'] ;?></td>
                            </td>
                            <td>
                                <td><?php echo $fm->formattime($result_club_event['event_start_time']) ;?></td>
                                <td><?php echo $fm->formattime($result_club_event['event_end_time']); ?></td>
                            </td>
