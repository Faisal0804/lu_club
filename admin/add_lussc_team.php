						...
						//club insert
						 $db=new database();
						  ...
						  if(isset($_POST['submit'])){
							  ...
							  if(empty($clubid) || empty($member_name || empty($member_designation))){
								echo "field must not be empty";
							  }else{
								$insert_query="insert into club_team(club_id,member_name,member_designation,member_image) 
                                values('$clubid','$member_name','$member_designation','$main_image')";
							...
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
							   ...
							   <div class="form-group">
									...
									<div class="col-sm-8">
										<select name="club_id" id="">
                                           ...
                                           <?php
                                            ...
                                            $read_club_team=$db->select($selectclub);
                                            if($read_club_team){
                                                while($result_club_team=$read_club_team->fetch_assoc()){
                                            
                                           
                                           ?>
                                            <option value="<?php echo $result_club_team['id'];?>"><?php echo $result_club_team['club_name'];?></option>
                                           <?php }}?>
                                        </select>
									</div>
								</div>
                                <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="member_name"  placeholder="Create club" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
                                        <input type="text" class="form-control1" name="member_designation"  placeholder="Create club" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="file" class="form-control1" name="member_image" placeholder="Choose Photo" >
									</div>
								</div>
